...
| | |
|:--|:--|
| **기간** | 2025.11 – 2025.12 &nbsp;·&nbsp; 1인 프로젝트 (기여도 100%) |
| **역할** | 총괄 |
| **Tech** | Kotlin · Room DB · Jetpack Compose · Google AI (DialogFlow ES) · FastAPI · Streamlit |

**Troubleshooting**

- **문제** — 키워드 인식 오류 (오탈자, 띄어쓰기 등)
- **해결** — 머신러닝 도입으로 인식 성능 100% 개선
- **성과** — 2025 제주 AI 청소년 경진대회 **대상** 수상

<br>

### Ara-Talk

> 제주대 공지사항을 실시간으로 낚아채, AI가 출처를 확인하고 정확하게 답변하는 지능형 학사 안내 챗봇

| | |
|:--|:--|
| **기간** | 2026.03 – 2026.06 &nbsp;·&nbsp; 4인 프로젝트 (팀장) |
| **Tech** | Python · FastAPI · Supabase DB (VectorDB) · Streamlit · Gemini API |

**성과 및 해결한 문제**

- Gemini API 기반 제주대 정보 제공형 챗봇 구축
- 할루시네이션 방지를 위해 RAG를 도입, 응답 신뢰도 개선

<br>

## Education & Experience

- 제주한라대학교 컴퓨터정보과 졸업 &nbsp;·&nbsp; 2022 – 2026
- 제주대학교 컴퓨터공학과 편입 &nbsp;·&nbsp; 2026 –
...
<div align="center">
<img src="https://github-readme-stats.vercel.app/api?username=Jeonbs1026&show_icons=true&theme=graywhite&hide_border=true&hide_title=true" width="48%" />
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Jeonbs1026&layout=compact&theme=graywhite&hide_border=true&hide_title=true" width="38%" />
</div>
...
![Profile views](https://komarev.com/ghpvc/?username=Jeonbs1026&style=flat-square&color=grey&label=views)
